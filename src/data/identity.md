---
# ─────────────────────────────────────────────────────────────────────────
# IDENTITY CONTENT — edit the fields below to change the "More »" detail
# panel in Section 01 (Identity). The layout is fixed; only the content
# here changes. Add/remove paragraphs and spec rows freely.
# ─────────────────────────────────────────────────────────────────────────

eyebrow: "Section 01 · Identity"
title: "Vincenzo Stira"
badge: "MONOIDX"
...
# Key/value rows shown beneath the copy.
specs:
  - label: "Focus"
